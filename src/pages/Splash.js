                            ...
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    <div className="react-image mb--20">
                                        <img src="./images/demo/react-badge.png" alt="CARS RENTAL PARIS React" />
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    title = "CARS RENTAL PARIS All Demo."
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <SectionTitle
                                    ...
                                    description = "Have a nice inner pages include in CARS RENTAL PARIS template."
