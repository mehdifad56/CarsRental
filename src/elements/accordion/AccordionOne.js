        ...
        <Accordion className={`rn-accordion-style ${customStyle}`} defaultActiveKey="0">
            <Card>
                ...
                <Accordion.Toggle as={Button} variant="link" eventKey="0">
                    What is CARS RENTAL PARIS ? How does it work?
                </Accordion.Toggle>
                </Card.Header>
                <Accordion.Collapse eventKey="0">
                    <Card.Body>Welcome to CARS RENTAL PARIS React Creative Agency, React Portfolio and Corporate Multi Purpose Template Built With React JS. NO jQuery!. </Card.Body>
                </Accordion.Collapse>
            </Card>
            ...
            <Card>
                ...
                <Accordion.Toggle as={Button} variant="link" eventKey="1">
                    How can I run CARS RENTAL PARIS react template?
                </Accordion.Toggle>
                </Card.Header>
                <Accordion.Collapse eventKey="1">
                    <Card.Body>You can run CARS RENTAL PARIS easily. First You'll need to have node and npm on your machine. So Please open your command prompt then check your node -v and npm -v Version. Goes To Your your command prompt: then First: npm install
