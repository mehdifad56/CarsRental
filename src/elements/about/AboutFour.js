                ...
                <div className="row row--40 align-items-center">
                    ...
                    <div className="col-lg-6 mt_md--40 mt_sm--40">
                        <div className="content">
                            <div className="inner">
                                <h3 className="title">CARS RENTAL PARIS specializes in <br /> small <strong>Corporate Business.</strong></h3>
                                ...
                                <div className="about-btn mt--30">
                                    <a className="btn-default" href="#">About Our CARS RENTAL PARIS</a>
                                </div>
                            </div>
                        </div>
                    </div>
