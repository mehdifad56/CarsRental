        ...
        <Router>
            <PageScrollTop>
                <Switch>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/Location-Voiture"}`} exact component={LocationVoiture}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/gallery/:id"}`} exact component={Gallery}/>
